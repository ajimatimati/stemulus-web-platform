...
const BlogEngine = (function() {
    ...
    function renderFeatured(post) {
        ...
        container.innerHTML = `
            <div class="bg-cosmic-blue text-white rounded-3xl shadow-xl overflow-hidden mb-16 flex flex-col md:flex-row group cursor-pointer animate-fadeIn">
                <div class="md:w-1/2 relative overflow-hidden h-64 md:h-auto">
                     ...
                     <img src="${post.image}" class="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" alt="${post.title}" loading="eager">
                </div>
                <div class="md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative z-20">
                    ...
                    <div class="flex items-center space-x-6">
                        <a href="${post.link}" class="inline-block font-bold text-cosmic-blue bg-white py-3 px-8 rounded-full hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">Read Full Article</a>
    ...
    function renderGrid(posts) {
        ...
        container.innerHTML = posts.map(post => `
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden group transform hover:-translate-y-2 transition-all duration-300 animate-fadeIn h-full flex flex-col" data-category="${post.category}">
                <div class="relative h-56 overflow-hidden flex-shrink-0">
                    <img src="${post.image}" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700" alt="${post.title}" loading="lazy">
                ...
                <div class="p-6 flex flex-col flex-grow">
                    ...
                    <a href="${post.link}" class="inline-flex items-center font-bold text-sm text-supernova-orange hover:text-orange-700 transition-colors mt-auto group/link">
     ...
     */
    async function init() {
        console.log("[STEMulus] Blog Engine: Initializing with Embedded Data...");
